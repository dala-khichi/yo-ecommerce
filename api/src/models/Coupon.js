...
class Coupon {
    ...
    static async create({ code, discount_percentage, max_discount_amount, min_order_amount, valid_from, valid_to, status  },id) {
      
      
        const query = `INSERT INTO coupons (code, discount_percentage, max_discount_amount, min_order_amount, valid_from, valid_to, status , created_by) 
                       VALUES (?, ?, ?, ?, ?, ?, ?,?)`;
