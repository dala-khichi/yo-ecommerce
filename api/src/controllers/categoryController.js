...
const createCategory = async (req, res) => {
  console.log(req.file);
    try {
        const id = await categoryService.createCategory(req.file?.filename,req.body,req?.admin?.id);
...
const updateCategory = async (req, res) => {
    try {
        await categoryService.updateCategory(req.params.id, req.file?.filename,req.body,req?.admin?.id);
