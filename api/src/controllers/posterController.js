...
const posterController = {
  create: async (req, res) => {
    try {
      const poster = await posterService.createPoster(req.file.filename,req.body,req?.admin?.id);
  ...
  update: async (req, res) => {
    ...
    try {
      await posterService.updatePoster(req.params.id,req.file?.filename, req.body,req?.admin?.id);
  ...
  delete: async (req, res) => {
    try {
      await posterService.deletePoster(req.params.id,req?.admin?.id);
