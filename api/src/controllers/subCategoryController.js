...
const createSubCategory = async (req, res) => {
    try {
        const id = await subCategoryService.createSubCategory(req.file?.filename,req.body,req?.admin?.id);
...
const updateSubCategory = async (req, res) => {
    try {
        await subCategoryService.updateSubCategory(req.params.id,req.file?.filename, req.body,req?.admin?.id);
