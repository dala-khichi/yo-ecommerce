...
class Coupon {
    ...
    static async getById(id) {
        const query = "SELECT code,discount_percentage,max_discount_amount,min_order_amount,valid_to FROM coupons WHERE id = ?";
    ...
    //////////////-------
    static async chack(code) {
        const query = "SELECT code,id FROM coupons WHERE code = ?";
