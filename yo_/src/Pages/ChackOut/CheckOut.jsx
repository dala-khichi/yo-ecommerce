...
<div className="border w-full  bg-gray-200 px-3 py-3 mt-2 ">
          ...
          <svg   className="inline "  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
